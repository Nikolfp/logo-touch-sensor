...
> Άνοιγμα αυτής της σελίδας στο [https://nikolfp.github.io/logo-touch-sensor/](https://nikolfp.github.io/logo-touch-sensor/)
...
* αναζήτηση για **https://github.com/nikolfp/logo-touch-sensor** και εισαγωγή
...
* επικολλήστε **https://github.com/nikolfp/logo-touch-sensor** και κάντε κλικ στην εισαγωγή
